    ...
    <section className="bg-white px-4 py-3 sm:py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <ScrollReveal delay={500}>
          <div className="relative mx-auto mt-8 max-w-3xl overflow-hidden rounded-2xl bg-gradient-to-br from-ramsider-black via-ramsider-black to-ramsider-purple/20 p-5 text-center text-white sm:p-8">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(200,38,211,0.15),transparent_50%)]" />
            <div className="relative z-10">
              <h3
                className="mb-2 font-display text-xl font-bold sm:text-3xl"
                dangerouslySetInnerHTML={{ __html: t('cta.title') }}
              />
              <p className="mb-4 font-body text-xs text-ramsider-gray sm:text-sm">
                {t('cta.subtitle')}
              </p>
              <Button variant="primary" className="bg-white px-5 py-2 text-[10px] text-ramsider-black hover:shadow-[0_0_40px_rgba(200,38,211,0.6)] sm:text-xs">
                {t('cta.button')}
              </Button>
              <div className="mt-4 flex items-center justify-center gap-3 text-[8px] sm:gap-5 sm:text-xs">
