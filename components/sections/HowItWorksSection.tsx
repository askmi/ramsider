...
export function HowItWorksSection() {
  ...
  const icons = [
    <svg key="capsule" className="h-16 w-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
    </svg>,
    <svg key="play" className="h-16 w-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>,
    <svg key="clock" className="h-16 w-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>,
    <svg key="smile" className="h-16 w-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {[0, 1, 2, 3].map((index) => (
            <ScrollReveal key={index} delay={index * 100}>
              <div className="text-center">
                <div className="mb-6 inline-flex h-24 w-24 items-center justify-center rounded-full border-2 border-ramsider-purple text-ramsider-purple">
                  {icons[index]}
                </div>
                <div className="mb-3 font-display text-6xl font-bold text-ramsider-purple">
                  {t(`steps.${index}.number`)}
                </div>
                <h3 className="mb-3 font-display text-xl font-bold">
                  {t(`steps.${index}.title`)}
                </h3>
                <p className="font-body text-ramsider-gray">
